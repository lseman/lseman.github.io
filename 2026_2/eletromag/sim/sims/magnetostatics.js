...
<div class="legend"><span class="legend-item"><span class="legend-dot" style="background:#fbbf24"></span>corrente</span><span class="legend-item"><span class="legend-dot" style="background:#67e8f9"></span>campo B</span><span class="legend-item"><span class="legend-dot" style="background:#fb7185"></span>maior |B|</span></div>`;
	...
	render(c) {
		...
		if(this.showProbe){c.fillStyle="rgba(7,10,18,.82)";c.fillRect(12,H-66,300,50);c.fillStyle="rgba(226,232,240,.8)";c.font="10px monospace";c.fillText(`sonda (${S.mouse.x.toFixed(0)}, ${S.mouse.y.toFixed(0)}) px`,22,H-48);c.fillText(`B=(${(probe.x*1e6).toFixed(3)}, ${(probe.y*1e6).toFixed(3)}) µT`,22,H-33);c.fillText(`|B|=${microT.toFixed(3)} µT`,22,H-19)}
