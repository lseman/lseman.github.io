...
<div class="legend"><span class="legend-item"><span class="legend-dot" style="background:#fbbf24"></span>corrente</span><span class="legend-item"><span class="legend-dot" style="background:#67e8f9"></span>campo B</span><span class="legend-item"><span class="legend-dot" style="background:#fb7185"></span>maior |B|</span></div>`;
	...
	render(c) {
		...
		if(this.showProbe){const probeW=315,probeH=64,probeX=W-probeW-16,probeY=60;c.fillStyle="rgba(7,10,18,.82)";c.beginPath();c.roundRect(probeX,probeY,probeW,probeH,8);c.fill();c.strokeStyle="rgba(103,232,249,.22)";c.stroke();c.fillStyle="rgba(226,232,240,.8)";c.font="10px monospace";c.fillText(`sonda (${S.mouse.x.toFixed(0)}, ${S.mouse.y.toFixed(0)}) px`,probeX+10,probeY+22);c.fillText(`B=(${(probe.x*1e6).toFixed(3)}, ${(probe.y*1e6).toFixed(3)}) µT`,probeX+10,probeY+40);c.fillText(`|B|=${microT.toFixed(3)} µT`,probeX+10,probeY+58)}
